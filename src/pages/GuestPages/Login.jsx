...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    setErrorMessage("");
    try {
      const response = await UseApi.login(credentials);
  ...
  return (
    <div className="mt-[120px] lg:mt-[100px] flex flex-col gap-2">
      ...
      <form
        ...
        className="lg:w-[50%] w-[95%] mx-auto rounded-lg p-6 bg-white shadow-2xl sm:rounded-3xl dark:border-gray-600 my-7"
      >
        ...
        <div className="mb-5">
          ...
          <div className="relative">
            ...
            <input
              ...
              onChange={handleChange}
              className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5 dark:placeholder-gray-400  dark:focus:ring-blue-500 dark:focus:border-blue-200"

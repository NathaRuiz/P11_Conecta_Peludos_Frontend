  ...
  return (
    <div className="bg-white rounded-xl shadow-xl w-[90%] lg:w-[80%] flex flex-col lg:flex-row flex-wrap m-auto justify-around py-5">
      ...
      <div className="lg:w-[48%] text-primaryColor py-5 px-7">
        <h2 className="font-bold mt-5 mb-5">¿Qué es la adopción responsable?</h2>
        <p className="text-sm mb-5">La adopción responsable implica comprometerse a proporcionar un hogar amoroso y cuidadoso a un animal. Al adoptar, estás asumiendo la responsabilidad de su bienestar a lo largo de toda su vida. Aquí hay algunos principios clave de la adopción responsable:</p>

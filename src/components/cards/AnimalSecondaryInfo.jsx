...
const AnimalSecondaryInfo = () => {
  ...
  return (
    <>
      <div className="lg:w-3/4 w-[90%] flex flex-col gap-2  bg-white rounded-lg overflow-hidden shadow-md p-4 ">
        <h3 className="font-bold text-primaryColor text-md">Mis Historia</h3>
        <div className="text-primaryColor text-sm">Podenco</div>
